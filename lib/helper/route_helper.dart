...
class RouteHelper {
  ...
  static const String histry = '/histry';
  ...
  static const String f_varification_screen = '/f_varification_screen';
  ...
  static const String add_money_succesful = '/add_money_succesful';
  ...
  static  getPinSetRoute({@required String fName,@required String lName, String email}) => '$pin_set_screen?f-name=$fName&l-name=$lName&email=$email';
  ...
  static  getRequestedMoneyRoute() => '$requested_money';
  static  getChangePinRoute() => '$change_pin_screen';
  static  getAddMoneyInputRoute() => '$add_money_input';
  static  getFVeryficationRoute({@required String phoneNumber}) => '$f_varification_screen?phone-number=$phoneNumber';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: share_statement, page: () => ShareStatementWidget(
    ...
    GetPage(name: histry, page: () => HistoryScreen()),
    ...
    GetPage(name: pin_set_screen, page: () => PinSetScreen(fName: Get.parameters['f-name'],lName: Get.parameters['l-name'],email: Get.parameters['email'],)),
    ...
    GetPage(name: login_screen, page: () => LoginScreen(countryCode: Get.parameters['country-code'].replaceAll(' ', '+'),phoneNumber: Get.parameters['phone-number'] != 'null' ? Get.parameters['phone-number'] : '' )),
    ...
    GetPage(name: f_varification_screen, page: () => FvarificationScreen(phoneNumber: Get.parameters['phone-number'].replaceAll(' ', '+'),)),
    ...
    GetPage(name: requested_money, page: () => RequestedMoneyListScreen()),
