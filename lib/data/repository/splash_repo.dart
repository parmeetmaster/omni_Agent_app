...
class SplashRepo {
  ...
  Future<bool> initSharedData() {
    ...
    if(!sharedPreferences.containsKey(AppConstants.AGENT_COUNTRY_CODE)) {
      return sharedPreferences.setString(AppConstants.AGENT_COUNTRY_CODE, AppConstants.languages[0].countryCode);
    }
    ...
    if(!sharedPreferences.containsKey(AppConstants.SHOW_ONBOARD_SCREEN)) {
      return sharedPreferences.setBool(AppConstants.SHOW_ONBOARD_SCREEN, false);
    }
