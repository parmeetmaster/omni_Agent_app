...
class LocalizationController extends GetxController {
  ...
  void loadCurrentLanguage() async {
    _locale = Locale(sharedPreferences.getString(AppConstants.LANGUAGE_CODE) ?? AppConstants.languages[0].languageCode,
        sharedPreferences.getString(AppConstants.AGENT_COUNTRY_CODE) ?? AppConstants.languages[0].countryCode);
  ...
  void saveLanguage(Locale locale) async {
    ...
    sharedPreferences.setString(AppConstants.AGENT_COUNTRY_CODE, locale.countryCode);
  }
