  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
      children: [
        ...
        ?Text(PriceConverter.convertPrice(profileController.userInfo.balance), style: rubikMedium.copyWith(color: ColorResources.whiteColor, fontSize: Dimensions.FONT_SIZE_OVER_LARGE,))
        :Text(PriceConverter.convertPrice(0.0), style: rubikMedium.copyWith(color: ColorResources.whiteColor, fontSize: Dimensions.FONT_SIZE_OVER_LARGE,)
          ),
        const SizedBox(
