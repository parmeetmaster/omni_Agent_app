            ...
            SizedBox(
              ...
              child: CarouselSlider.builder(itemCount: controller.bannerList.length,
                itemBuilder: (context, index, realIndex) {
                  ...
                  return InkWell(
                    onTap: controller.bannerList.length > 0 ? () => Get.to(WebScreen(fromLinkClick: true, url: controller.bannerList[index].url)) : () {},
                    ...
                    child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_DEFAULT),
                      child: Container(
                        ...
                        child: ClipRRect(borderRadius: BorderRadius.circular(10),
                          child: CustomImage(image: "${Get.find<SplashController>().configModel.baseUrls.bannerImageUrl}/$image",
                            fit: BoxFit.cover,
