                  ...
                  child: Column(
                    ...
                    children: [
                     ...
                     // widget.transactionType != 'request_money' ? Text('charge'.tr + ' ' + widget.charge, style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE,color: ColorResources.getPrimaryColor())) : SizedBox.shrink(),
                      ...
                      Center(child: Text(widget.transactionType == TransactionType.ADMIN_CASH_OUT ? 'cash_out_from_admin'.tr :
                      '${widget.contactModel.name == null ? '' : widget.contactModel.name} (${widget.contactModel.phoneNumber})', textAlign: TextAlign.center,
                          style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE, color: ColorResources.getPrimaryColor(),))),
