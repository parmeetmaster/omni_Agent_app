...
class TransactionMoneyBalanceInput extends StatefulWidget {
  ...
  TransactionMoneyBalanceInput({Key key, this.transactionType})
      : super(key: key);
...
class _TransactionMoneyBalanceInputState
  ...
  void setInputValue(String amount) {
    _inputAmountController.text =
        splashController.configModel.currencyPosition == 'left'
            ? '${splashController.configModel.currencySymbol}$amount'
            : '$amount${splashController.configModel.currencySymbol}';
  ...
  void initState() {
    ...
    Get.find<TransactionMoneyController>().selectAmountSet(
        Get.find<TransactionMoneyController>()
            .inputAmountList
            .indexOf(AppConstants.inputAmountList.first));
  }
        ...
        child: Scaffold(
            appBar: CustomAppbar(
                title: widget.transactionType == TransactionType.SEND_MONEY
                    ? 'send_money'.tr
                    : widget.transactionType == TransactionType.ADMIN_CASH_OUT
                        ? 'cash_out_from_admin'.tr
                        : widget.transactionType == TransactionType.ADD_MONEY
                            ? 'add_money'.tr
                            : 'request_money_to_admin'.tr),
                                    ...
                                    child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          prefixIcon: CustomCountryCodePiker(
                                            ...
                                            onChanged:
                                                (CountryCode countrypacket) {
                                              _countryCode =
                                                  countrypacket.dialCode;
                                            },
                                          ),
                                        ))),
                                Icon(Icons.search,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      GetBuilder<TransactionMoneyController>(
                        ...
                        return controller.isLoading
                            ? widget.transactionType ==
                                        TransactionType.ADMIN_CASH_OUT &&
                                    widget.transactionType !=
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                            children: transactionMoneyController.inputAmountList
                                .map((amount) =>
                                    GetBuilder<TransactionMoneyController>(
                                        ...
                                        builder: (inputAmountListController) {
                                          return Padding(
                                            ...
                                            child: RoundedTextSelectionButton(
                                                index: inputAmountListController
                                                    .inputAmountList
                                                    .indexOf(amount),
                    ...
                    if (amount == 0) {
                      ...
                      if (widget.transactionType !=
                        ...
                        transactionMoneyController
                            .checkCustomerNumber(phoneNumber: _phoneNumber)
                            .then((value) {
                          if (value.isOk) {
                        ...
                        Get.to(() => TransactionMoneyConfirmation(
                            ...
                            transactionType: widget.transactionType,
                            contactModel:
                                ContactModel(phoneNumber: _phoneNumber)));
                      }
                    }
                  }
                },
