                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      InputSecton(fNameController: fNameTextController,lNameController: lNameTextController,emailController: emailTextController,),
                      const SizedBox(
                      ...
                      if (fNameTextController.text == '' || lNameTextController.text == '') {
                        ...
                        if(emailTextController.text != ''){
                          ...
                          if(!_emailValid){
                            ...
                            print('with email');
                            Get.toNamed(RouteHelper.getPinSetRoute(fName: fNameTextController.text,lName: lNameTextController.text,email: emailTextController.text));
                          }
                        }
                        else{
                          print('without email');
      ...
      showAnimatedDialog(context,
          MyDialog(
            ...
            onTap: (){
                ...
                //return Get.offAllNamed(RouteHelper.getLoginRoute(countryCode: countryCode, phoneNumber: phoneNumber));
            },
          ),
          dismissible: false,
          isFlip: true);
