...
class ColorResources {
  ...
  static Color getGreyBaseGray6() {
    return Get.isDarkMode ? Theme.of(Get.context).cardColor : Color(0xFFF2F2F7);
  }
  ...
  static Color getTabGrayColor() {
    return Get.isDarkMode ? Color(0xFF5092b9) : Color(0xFFb8d6e5);
  }
  ///#686868
  ...
  // static const Color TAB_GRAY = Color(0xFFe2eff4);
  static const Color SEARCH_GRAY = Color(0xFFF2F2F6);
